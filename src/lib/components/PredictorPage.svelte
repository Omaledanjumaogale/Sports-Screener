<script lang="ts">
  ...
  import { ArrowLeft, ArrowDown, ArrowUp, Inbox, Clock3, Check, ChevronLeft, Wand2, Activity, Search, X } from '@lucide/svelte';
...
<style>
  ...
  /* ── League group headers (always visible — the match title tab is the
        accordion; league sections stay expanded) ── */
  .league-accordion {
    width: 100%;
    display: flex;
    align-items: center;
  ...
  .league-accordion.static { cursor: default; }
