<script lang="ts">
  ...
  import { ArrowLeft, RefreshCw, Inbox, Clock3, Check, ChevronLeft, Wand2 } from '@lucide/svelte';
...
<div class="predictor-root" style={`--accent:${accent}`}>
  <div class="predictor-inner">
    ...
    {#if loading}
      <div class="placeholder">Loading today's scheduled matches…</div>
    {:else}
      ...
      {#if phase === 'select'}
        ...
        {:else}
          <div class="empty-state">
            ...
            <p>No scheduled matches cached for today.</p>
